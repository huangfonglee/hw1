...
if (TEMP_C0A880 == 0) :
   ...
   val_C0A880 = str(format(TEMP_C0A880, '.2f'))
if (TEMP_C0F9A0 == 0) :
   val_C0F9A0 = str(None)
else :
   val_C0F9A0 = str(format(TEMP_C0F9A0, '.2f'))
if (TEMP_C0G640 == 0) :
   val_C0G640 = str(None)
else :
   val_C0G640 = str(format(TEMP_C0G640, '.2f'))
if (TEMP_C0R190 == 0) :
   val_C0R190 = str(None)
else :
   val_C0R190 = str(format(TEMP_C0R190, '.2f'))
if (TEMP_C0X260 == 0) :
   val_C0X260 = str(None)
else :
   val_C0X260 = str(format(TEMP_C0X260, '.2f'))
